...
if __name__ == "__main__":
    ...
    train_dir = "/public3/Xinyu/3D_tissue/IF/Vascular_stat/patch/train"
    val_dir   = "/public3/Xinyu/3D_tissue/IF/Vascular_stat/patch/test"
    
    save_dir  = "/public3/Xinyu/3D_tissue/IF/Vascular_stat/models"
