...
# ================= 修改区 =================
# 原图路径 (CD31 单通道)
img_path  = f'/public3/Xinyu/3D_tissue/IF/Vascular_stat/CD31_tif/{sample}.tif'

# 掩码图路径
mask_path = f'/public3/Xinyu/3D_tissue/IF/Vascular_stat/{sample}_mask.tif' 
# ==========================================

# 输出目录
base_out = f'/public3/Xinyu/3D_tissue/IF/Vascular_stat/patch/{sample}_{patch_size}_CD31_Balanced'
