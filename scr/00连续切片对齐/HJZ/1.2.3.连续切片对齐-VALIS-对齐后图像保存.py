...
region = '00004-07662-12501'

registrar = registration.load_registrar(f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/ROI-{region}/Micro-registration/ROI-{region}/data/ROI-{region}_registrar.pickle')

files = [entry.name for entry in os.scandir(f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/ROI-{region}') if entry.is_file()]
...
for i in files:
    ...
    CD31_index = 3
    out_file = f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/ROI-{region}/Micro-registration/micro_registered_slides_LYVE1'
    ...
    # 我这里直接使用 arr_cyx
    slide_f = f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/ROI-{region}/{i}'
