...
if __name__ == "__main__":
    # ================= 参数配置 =================
    # 输入：预测出来的原始 Mask 路径
    input_dir = "/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/prediction/ROI-00004-07662-12501"
    
    # 输出：处理后的 Mask 路径
    output_dir = "/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/prediction_postprocessed/ROI-00004-07662-12501"
