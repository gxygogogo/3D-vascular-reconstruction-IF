...
def organize_channels_automatically(base_dir, target_dapi_dir=None, target_all_channels_dir=None):
    ...
    Args:
        ...
        target_all_channels_dir: 若给定, 则把匹配其他通道 (ch01/ch02) 的文件移动到这里；若为 None, 函数会在 base_dir 下创建 all_channels/ 子目录
    """
...
# 创建基本目录，并自动组织文件
base_dir = "/mnt/d/path to your folder/"
...
# DAPI目录下的参考切片
reference_slide_name = "reference image.tif" # Update this to your actual reference
...
registrar = registration.Valis(clahe_padded_dir, # Directory with CLAHE-padded DAPI images
                               dst_dir,
...
## 创建 CLAHE-padded 和 Original-padded 图像之间的映射
