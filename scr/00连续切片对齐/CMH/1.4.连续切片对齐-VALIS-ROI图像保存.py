...
region = '00003-09235-15387'

registrar = registration.load_registrar(f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/CMH-{region}/Micro-registration/CMH-{region}/data/CMH-{region}_registrar.pickle')

files = [entry.name for entry in os.scandir(f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/CMH-{region}') if entry.is_file()]

pat = re.compile(r'CMH_\d+-\d+-\d+-\d+')
for i in files:
    print(i)
    # 可调参数
    m = pat.search(i)
    ...
    CD31_index = 1
    out_file = f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/CMH-{region}/Micro-registration/micro_registered_slides_CD31'
    ...
    # 我这里直接使用 arr_cyx
    slide_f = f'/public3/Xinyu/3D_tissue/IF/02.mIHC_ROI_RigidMicro_registration/CMH-{region}/Micro-registration/micro_registered_slides/{i}'
