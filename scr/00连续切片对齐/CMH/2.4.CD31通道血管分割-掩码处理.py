...
if __name__ == "__main__":
    # ================= 参数配置 =================
    # 输入：预测出来的原始 Mask 路径
    input_dir = "/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/prediction/CMH-00003-16139-16967"
    
    # 输出：处理后的 Mask 路径
    output_dir = "/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/prediction_postprocessed/CMH-00003-16139-16967"
    
    # 参数微调
    MIN_AREA = 800       # 过滤阈值：小于 500 像素的碎块会被删掉 
