...
mask_dir = f"/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/prediction_postprocessed/{roi}"
    
# 3. 输出文件夹 (Extraction)
output_dir = f"/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/signal_extraction/{roi}"
