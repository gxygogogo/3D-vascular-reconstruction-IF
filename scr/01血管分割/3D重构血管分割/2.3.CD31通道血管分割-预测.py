...
if __name__ == "__main__":
    roi_list = ['CMH-00003-16139-16967', 'CMH-00003-09235-15387']
    for roi in roi_list:
        ...
        for i in file_list:
            ...
            model_path = "/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/models/best_cd31_unet.pth"
            ...
            # 3. 输出路径
            output_mask_path = f"/public3/Xinyu/3D_tissue/IF/03.mIHC_vascular_segmentation/CMH/prediction/{base}_pred_mask.tif"
